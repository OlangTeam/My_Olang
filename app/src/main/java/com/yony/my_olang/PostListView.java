...
// 컴포넌트 초기화
            listView = findViewById(R.id.freeBoardList);
...
// 게시물의 번호와 userid를 가지고 DetailActivity 로 이동
                    Intent intent = new Intent(PostListView.this, PostView.class);
...
// userid 를 가지고 RegisterActivity 로 이동
                    Intent intent = new Intent(PostListView.this, PostWriteView.class);
                    intent.putExtra("userid", userid);
                    startActivity(intent);
                }
            });
...
// userid 를 가지고 RegisterActivity 로 이동
                    Intent intent = new Intent(PostListView.this, SearchFindView.class);
                    startActivity(intent);
                }
            });
        }
...
// ListView 에서 사용할 arrayAdapter를 생성하고, ListView 와 연결
                    ArrayAdapter arrayAdapter = new ArrayAdapter<String>(PostListView.this, android.R.layout.simple_list_item_1, titleList);
